...
classLabels=['dog', 'landmark', 'sofa', 'chair', 'table', 'bed', 'ashcan', 'shoe']
...
##                    print tmp
    ...
    def selectdog(self):
        self.currentClass = 'dog'
        self.classbox.delete(0,END)
        self.classbox.insert(0, 'dog')
        self.classbox.itemconfig(0,fg = COLORS[0])
    ...
    def selectlandmark(self):
        self.currentClass = 'landmark'
        self.classbox.delete(0,END)
        self.classbox.insert(0, 'landmark')
        self.classbox.itemconfig(0,fg = COLORS[0])
